    ...
    <section className="relative bg-cover rounded-2xl" style={{ backgroundImage: "url('/assets/basic/explore-bg.webp')" }}>
      ...
      <div className='flex flex-col justify-center items-center p-8'>
        <div className='text-center space-y-5'>
          ...
          <p className="text-white text-[32px] font-bold leading-[44px]">Over 200+ Online Courses</p>
          ...
          <div className="flex flex-row gap-3 ">
            {['Class1', 'Class2', 'Class3', 'Class4', 'Class5', 'Class6', 'Class7', 'Class8'].map((tab) => (
              <Button
                ...
                className={`text-white rounded-full px-5 py-2 text-sm font-semibold transition-all ${activeTab === tab ? 'bg-secondary' : 'border border-white bg-transparent'}`}
